          ...
          <div className="grid gap-10 lg:grid-cols-2 lg:items-center">
            ...
            <div className="relative">
              <img
                ...
                className="h-72 w-full rounded-2xl object-cover ring-1 ring-[#e8c49a] lg:h-80"
              />
              <div
                className="absolute -bottom-4 -right-4 hidden sm:block rounded-xl 
              ...
              shadow-lg"
              >
                <p className="font-serif text-3xl font-bold text-white">Est.</p>

                <p className="font-serif text-3xl font-bold text-[#f7d9a8]">
                  yyyy
                </p>

                <p className="mt-1 text-[10px] font-medium uppercase tracking-widest text-[#f1e3cf]">
        ...
        <div className="mx-auto max-w-screen-2xl">
          <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-start">
            <div>
              ...
              <p className="mt-4 text-sm leading-7 text-[#e6c79c]">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              {beliefs.map((b) => (
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#e6c79c]">
                    {b.detail}
                  </p>
                </div>
              ))}
