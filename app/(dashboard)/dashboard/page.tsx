...
export default function DashboardPage() {
  ...
  const newsletters = useNewsletters({ page: 1, limit: 1 });
  ...
  const moduleSummaries: ModuleSummary[] = [
    ...
    {
      label: "Newsletters",
      description: "Newsletter files and publishing",
      href: "/dashboard/newsletters",
      createHref: "/dashboard/newsletters/new",
      count: getCount(newsletters.data),
      isLoading: newsletters.isLoading,
